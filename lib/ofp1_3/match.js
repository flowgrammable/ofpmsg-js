...
Match.prototype.fromTiny = function(matchSet){
  ...
  console.log('tiny matchset', matchSet);
  _(matchSet).forEach(function(m){
    var hasMask = m.mask ? true : false;
    console.log('has mask:', hasMask);
...
OXM.prototype.toView = function(view){
  ...
  if(this.hasMask){
    ...
    console.log('field val hasmask:', this.field);
  } else {
    this.field._value = ( this.field._value << 1);
  }
