...
function DescriptionReq(){ 
  this.Type    = uint.mk(1, DescriptionReq.Type); 
}
...
exports.DescriptionReq = function(args) {
  return new StatsReq({ payload: new DescriptionReq() });
};
...
exports.DescriptionRes = function(args) {
  return new StatsRes({ payload: new DescriptionRes(args) });
};

function TableReq(){
  this.Type    = uint.mk(1, TableReq.Type);
}
...
TableReq.prototype.fromView = function(view){
  if(view.available() < this.bytes()){
   throw util.Available('StatsReqTableReq');
  }
 return this;
}; 
...
exports.TableReq = function(args) {
  return new StatsReq({ payload: new TableReq() });
};
...
exports.TableRes = function(args) {
  return new StatsRes({ payload: new TableRes(args) });
};
